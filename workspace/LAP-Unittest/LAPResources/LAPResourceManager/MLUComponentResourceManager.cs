...
namespace LAPResourceManager
{
    ...
    public class internalResourceManager : ResourceManager
    {
        ...
        public internalResourceManager(Type t)
            : base(t)
        {
        }

        public internalResourceManager(string baseName, Assembly assembly)
    ...
    public class MLUComponentResourceManager : ComponentResourceManager
    {
        protected internalResourceManager _ResMgr = null;
        public MLUComponentResourceManager()
            : base()
        {
        }

        public MLUComponentResourceManager(Type t)
            : base(t)
        {
        }

        public MLUComponentResourceManager(string baseName, Assembly assembly)
        {
            _ResMgr = new internalResourceManager(baseName, assembly);
        }

        public override void ApplyResources(object value, string objectName, CultureInfo culture)
        {
            if (null != _ResMgr)
                _ResMgr.ApplyResources(value, objectName, culture);
            else
