...
{
    [Guid("1ABD369E-746B-483A-ABF7-14B30FB78FF6")]
    public interface IUIAImage
    {
        [DispId(1)]
    ...
    [Guid("8EEC18D4-558A-4F75-B57C-25182C47FBAD")]
    [ProgId("LeanPro.UIAImage")]
    [TypeLibType((short)2)]
    [ComSourceInterfaces(typeof(IUIAImage))]
    [Description("Automation UIA Image")]
    public class UIAImage : UIAContainerBase, IUIAImage
    {
        public UIAImage(UIACondition condition)
            : base(condition)
        { }
